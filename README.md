AlMonther's binary trees with C language. ALX SE
to be edited/checked later when the time allows.

> C is a powerful general-purpose programming language. It can be used to develop software like operating systems, databases, compilers, and so on. This projects covers the concepts of binary trees! This was a project.
